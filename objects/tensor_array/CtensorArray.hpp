...
namespace cnine{
  ...
  public: // ---- Named constructors -------------------------------------------------------------------------
    ...
    static CtensorArray zero(const Gdims& _adims, const Gdims& _dims, const int nbd, const device& _dev){
      return CtensorArray(_adims,_dims,nbd,fill::zero,_dev.id());}
    static CtensorArray zero(const Gdims& _adims, const Gdims& _dims, const device& _dev){
      return CtensorArray(_adims,_dims,-1,fill::zero,_dev.id());}

    static CtensorArray ones(const Gdims& _adims, const Gdims& _dims, const int nbd=-1, const int _dev=0){
      return CtensorArray(_adims,_dims,nbd,fill::ones,_dev);}
    static CtensorArray ones(const Gdims& _adims, const Gdims& _dims, const int nbd, const device& _dev){
      return CtensorArray(_adims,_dims,nbd,fill::ones,_dev.id());}
    static CtensorArray ones(const Gdims& _adims, const Gdims& _dims, const device& _dev){
      return CtensorArray(_adims,_dims,-1,fill::ones,_dev.id());}

    //static CtensorArray identity(const Gdims& _adims, const Gdims& _dims, const int nbd=-1, const int _dev=0){
    //return CtensorArray(_adims,_dims,nbd,CtensorA_setIdentity_cop(),_dev);}
    //static CtensorArray identity(const Gdims& _adims, const Gdims& _dims, const int nbd, const device& _dev){
    //return CtensorArray(_adims,_dims,nbd,CtensorA_setIdentity_cop(),_dev.id());}
    ...
    static CtensorArray sequential(const Gdims& _adims, const Gdims& _dims, const int nbd=-1, const int _dev=0){
      return CtensorArray(_adims,_dims,nbd,fill::sequential,_dev);}
    static CtensorArray sequential(const Gdims& _adims, const Gdims& _dims, const int nbd, const device& _dev){
      return CtensorArray(_adims,_dims,nbd,fill::sequential,_dev.id());}
    static CtensorArray sequential(const Gdims& _adims, const Gdims& _dims, const device& _dev){
      return CtensorArray(_adims,_dims,-1,fill::sequential,_dev.id());}

    static CtensorArray gaussian(const Gdims& _adims, const Gdims& _dims, const int nbd=-1, const int _dev=0){
      return CtensorArray(_adims,_dims,nbd,fill::gaussian,_dev);}
    static CtensorArray gaussian(const Gdims& _adims, const Gdims& _dims, const int nbd, const device& _dev){
      return CtensorArray(_adims,_dims,nbd,fill::gaussian,_dev.id());}
    static CtensorArray gaussian(const Gdims& _adims, const Gdims& _dims, const device& _dev){
      return CtensorArray(_adims,_dims,-1,fill::gaussian,_dev.id());}
