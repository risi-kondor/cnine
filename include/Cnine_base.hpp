...
#define CNINE_IN_RANGE(ix,tsize) if(i>=tsize) throw std::out_of_range("Cnine error in "+string(__PRETTY_FUNCTION__)+": index "+to_string(ix)+" out of range (0,"+to_string(tsize-1)+").");
